...
import { faBook, faBoxOpen, faChartPie, faShoppingBag,faCog, faFileAlt, faHandHoldingUsd, faIcons, faSignOutAlt, faTable, faTimes, faUsers, faTruck, faTruckLoading, faTruckMoving, faThermometer, faRuler, faCalculator, faFileInvoice, faUser, faCreditCard, faMoneyBillWaveAlt } from "@fortawesome/free-solid-svg-icons";
...
export let routes = [
    ...
    { path: "/", component: DashboardOverview, title:"Dashboard",icon: faChartPie,},
    { path: "/company-profile", component: Profile, title:"Company Profile",icon: faUser,},
    { path: "/users",component: Index, title:"Users",icon:faUsers },
    { path: "/suppliers",component: SupplierIndex, title:"Suppliers",icon:faTruck },
    { path: "/products",component: Product, title:"Products",icon:faTruckLoading },
    { path: "/purchase_orders",component:OrderIndex, title:"Purchase Order",icon:faShoppingBag },
    { path: "/stocked",component: BranchIndex, title:"Stocks",icon:faTruckMoving },
    { path: "/sales_order",component: SalesOrderIndex, title:"Sales Order",icon:faRuler },
    { path: "/creditors", component: CreditorIndex, title:"Creditors", icon:faCreditCard },
    { path: "/expenses", component: ExpenseIndex, title:"Expenses", icon:faMoneyBillWaveAlt },
